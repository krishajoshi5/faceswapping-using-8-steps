...
cv2.imshow("image2 mask", img2_face_mask)
cv2.imshow("image2 face mask", img2_face_mask)
cv2.imshow("image2 Head Mask Non Face", img2_head_noface)

cv2.imshow("image2 Head Mask Non Face", img2_new_face_rect_area)
